...
export default function DynamicHeroImage() {
  return (
    <div className="w-full bg-blue-50 py-32">
      <div className=" bg-cover bg-no-repeat pl-32 flex justify-between  items-center h-[560px] w-full object-cover">
        <div className="text-6xl font-bold w-1/2 text-[#345873] ">
          <p className="text-blue-600 text-4xl mb-2">Experienced</p>{" "}
          <Typewriter
            options={{
          ...
          />{" "}
          <p className="text-blue-600 text-4xl mt-2">services for your home</p>{" "}
          <a
            href="/get-a-quote"
            className="py-3 px-4 inline-flex hover:text-blue-600 hover:border-blue-600   border-transparent bg-blue-600 text-white items-center gap-x-2 text-sm font-medium  mt-40 border    shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
          >
            Get a Quote
            <svg
        ...
        <div className="flex relative items-center  ">
          <img
            ...
            className="h-96 w-60 relative  object-cover"
          />
