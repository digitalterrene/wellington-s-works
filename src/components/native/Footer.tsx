...
export default function Footer() {
  return (
    <div>
      <footer className="flex flex-col items-center bg-neutral-200 text-center bg-[#1C2335] text-white dark:bg-neutral-600">
        <div className="container pt-9">
          <div className="mb-9 flex justify-center">
            <a
              href="https://www.facebook.com/people/Digital-Painting-Agency/61554939347804/"
            ...
            <a
              href="https://www.instagram.com/dpa_vertueal?igsh=ZXgwbHQ2eHEzZXVw"
              className="mr-9 text-neutral-800 dark:text-neutral-200"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
